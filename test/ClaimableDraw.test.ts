...
describe('ClaimableDraw', () => {
  ...
  describe('claim()', () => {
    ...
    it('should create a 257 draws and user should claim all non-expired draw ids', async () => {
      ...
      expect(await claimableDraw.hasClaimed(wallet1.address, 7))
        .to.equal(true)
    ...
    it('should create a 320 draws and user should claim all non-expired draw ids in 3 separate transactions', async () => {
      ...
      for (let index = 0; index < drawsIdsSplit[1].length; index++) {
        ...
        expect(await claimableDraw.hasClaimed(wallet1.address, element))
          .to.equal(true)
      }
      ...
      expect(await claimableDraw.userClaimedDraws(wallet1.address))
        .to.equal('0xfffffffffffffffffffffffffffffffffffffffffffffffeffffffffffffffff')
