...
describe('PrizePool', function () {
  ...
  before(async () => {
    ...
    ERC721MintableContract = await getContractFactory('ERC721Mintable', contractsOwner);
    PrizePoolHarness = await getContractFactory('PrizePoolHarness', contractsOwner);
