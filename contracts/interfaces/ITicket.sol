...
interface ITicket {
  ...
  */
  function getAccountDetails(address user) external view returns (AccountDetails memory);
  ...
  */
  function getTotalSupplies(uint32[] calldata timestamps) external view returns(uint256[] memory);
}
